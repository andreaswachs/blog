...
- **Aspartame** (E951) — used in Diet Coke, tabletop packets
- **Sucralose** (E955) — used in Splenda, baked goods
- **Acesulfame potassium / Ace-K** (E950) — often combined with other sweeteners
- **Saccharin** (E954) — one of the oldest, still in some tabletop products
- **Steviol glycosides (stevia)** — plant-derived, marketed as "natural"
- **Erythritol** — a sugar alcohol increasingly used in "keto" and low-carb products
- **Allulose** — a rare sugar with minimal caloric impact
...
- **Total artificial sweetener intake** was associated with a **9% higher risk of cardiovascular disease** (HR 1.09, 95% CI 1.01–1.18)
- The association was stronger for **cerebrovascular disease** (stroke): 18% higher risk (HR 1.18, 95% CI 1.06–1.31)
- **Aspartame** was specifically linked to cerebrovascular events (HR 1.17)
- **Acesulfame potassium** and **sucralose** were linked to coronary heart disease (HR 1.40 and 1.31 respectively)
...
- **Type 2 diabetes** (HR 1.26, 95% CI 1.14–1.40)
- **Hypertension** (HR 1.13, 95% CI 1.09–1.18)
- **Heart failure** (HR 1.26, 95% CI 1.14–1.39)
- **Stroke** (HR 1.12, 95% CI 1.05–1.19)
- **Coronary artery disease** (HR 1.11, 95% CI 1.00–1.23)
- **All-cause mortality** (HR 1.09, 95% CI 1.01–1.17)
...
- In metabolomics studies of patients undergoing cardiac risk assessment, **circulating erythritol levels were associated with 3-year risk of major adverse cardiovascular events** (MACE — death, heart attack, or stroke)
- This association was validated in two independent cohorts (US and European)
- At physiological concentrations, **erythritol enhanced platelet reactivity and thrombosis formation** in both in vitro and animal models
- In a pilot intervention, **erythritol ingestion in healthy volunteers produced sustained elevations in plasma erythritol** above the threshold linked to heightened platelet reactivity
...
- **13% higher risk of overall cancer** (HR 1.13, 95% CI 1.03–1.25)
- **Aspartame** was associated with a 15% higher overall cancer risk and a **22% higher risk of breast cancer**
- **Acesulfame-K** was associated with a 13% higher overall cancer risk
...
- **Glucose and insulin areas under the curve increased** during a mixed meal tolerance test
- **Insulin sensitivity decreased** (measured by the Matsuda index)
- **Gut microbiota alpha-diversity decreased**
- Changes in metabolites suggested altered microbial function
...
- **Saccharin and sucralose** have the most pronounced negative effects on glucose tolerance in animal models
- **Steviol glycosides** appear more neutral or even slightly beneficial in some studies
- **Aspartame** is metabolized into amino acids and methanol in the small intestine, so less reaches the colon intact
...
- A **2026 mouse study** (Zhang et al., *Journal of Diabetes Research*) found that **gestational sucralose exposure increased gestational diabetes risk** via gut microbiota dysbiosis and metabolic disruption. Fecal microbiota transplantation from sucralose-exposed pregnant mice into control pregnant mice recapitulated the GDM phenotype, establishing a causal role for the microbiome.
- A **2025 study** (de Oliveira et al., *Biology of Sex Differences*) found that gestational saccharin consumption disrupted gut-brain axis glucose homeostasis in adolescent offspring rats in a sex-dependent manner.
- A **2026 study** (Xie et al., *Food and Chemical Toxicology*) showed that maternal rebaudioside A and acesulfame-K exposure reprogrammed offspring submandibular gland development in a sex-dependent manner.
...
- **In RCTs**, children randomly assigned to drink NNS beverages instead of sugar-sweetened beverages showed **slightly less BMI gain** (mean difference -0.11 kg/m²) over ~43 weeks
- This benefit was most pronounced in **adolescents with obesity** at baseline
- **In cohort studies** (which observe real-world patterns rather than assigning interventions), there was **no significant association** between NNS beverage consumption and BMI changes
- The authors noted that no studies evaluated NNS in food (as opposed to beverages), and none compared NNS beverages to water
...
- **Aspartame** was dose-dependently associated with increased pediatric hypertension risk (OR 1.69)
- **Added sugars** showed an even stronger association (OR 2.63)
- **Steviol glycosides** showed borderline protective effects
- The effect of aspartame on hypertension was stronger in **boys** (OR 3.13) than in girls
- Replacing added sugars with NNS was associated with **lower hypertension risk overall**
...
- **Condition the palate to expect high sweetness**, making naturally sweet foods (fruit) seem bland and vegetables unpalatable
- **Displace nutrient-dense foods** from the diet
- **Establish a dietary pattern** that persists into adulthood
...
- The Taiwan pediatric hypertension study found **steviol glycosides were borderline protective**
- Mechanistic studies suggest stevia has less impact on gut microbiota than sucralose or saccharin
- However, "natural" is not synonymous with "harmless." Stevia extracts are still highly processed, and long-term safety data in children remain limited
...
- NNS use does not confer any long-term benefit in reducing body fat in adults or children
- Long-term use may increase the risk of type 2 diabetes, cardiovascular diseases, and mortality
...
- Debras C, et al. (2022). Artificial sweeteners and risk of cardiovascular diseases: results from the prospective NutriNet-Santé cohort. *BMJ*, 378:e071204. doi:10.1136/bmj-2022-071204
- Debras C, et al. (2022). Artificial sweeteners and cancer risk: Results from the NutriNet-Santé population-based cohort study. *PLOS Medicine*, 19(3):e1003950. doi:10.1371/journal.pmed.1003950
- Witkowski M, et al. (2023). The artificial sweetener erythritol and cardiovascular event risk. *Nature Medicine*, 29, 710–718. doi:10.1038/s41591-023-02277-0
- World Health Organization. (2023). WHO advises not to use non-sugar sweeteners for weight control in newly released guideline. *Saudi Medical Journal*, 44(6):636. doi:10.15537/smj.2023.44.6.636
- World Health Organization / IARC. (2023). Aspartame – IARC Monographs evaluation and JECFA risk assessment. https://www.who.int/news-room/detail/14-07-2023-aspartame-hazard-and-risk-assessments-released
- Kim Y, et al. (2026). Artificial sweeteners and risk of cardiometabolic outcomes and mortality: a systematic review and meta-analysis. *Nutrition Research and Practice*, 20(3):359. doi:10.4162/nrp.2026.20.3.359
- García-Martínez BI, et al. (2024). Effects of Nonnutritive Sweeteners on the BMI of Children and Adolescents: A Systematic Review and Meta-Analysis. *Advances in Nutrition*, 15(4):100292. doi:10.1016/j.advnut.2024.100292
- Lin LY, et al. (2025). Varied effects of sweeteners on pediatric hypertension: A multicenter study. *Clinical Nutrition*, 44:221–231. doi:10.1016/j.clnu.2024.12.024
- Romo-Romo A, et al. (2025). Sucralose consumption modifies glucose homeostasis, gut microbiota, Curli protein, and related metabolites in healthy individuals. *Clinical Nutrition ESPEN*. doi:10.1016/j.clnesp.2025.08.029
- Tang J, et al. (2026). Artificial Sweeteners and Gut Microbiota: Mechanistic Insights and Implications for Metabolic Health. *Current Nutrition Reports*. doi:10.1007/s13668-026-00768-y
- Zhang Y, et al. (2026). Sucralose Exposure During Pregnancy Elevates Gestational Diabetes Risk via Gut Microbiota-Metabolic Axis in Mice. *Journal of Diabetes Research*, 8638903. doi:10.1155/jdr/8638903
- Wang Z, et al. (2024). Association between sugar-free beverage intake and childhood obesity among Chinese children and adolescents. *Pediatric Obesity*, 19(3):e13125. doi:10.1111/ijpo.13125
- Mozaffarian D, et al. (2025). Non-Sugar-Sweetened Beverages and Risk of Chronic Diseases: An Umbrella Review. *Nutrition Reviews*. doi:10.1093/nutrit/nuaf028
- WHO Guideline. (2023). Use of non-sugar sweeteners. Geneva: World Health Organization. Licence: CC BY-NC-SA 3.0 IGO. https://iris.who.int/handle/10665/366537
